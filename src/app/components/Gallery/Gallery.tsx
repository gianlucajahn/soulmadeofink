...
const experiences = [
    ...
    content:
      "To me, love has always been just a chemical reaction that compels animals to breed, and although biological circumstances are making me feel it very, very strongly (believe me when I say that, I don’t know many people who romanticize a loving relationship as much as I do), it is still with a heavy heart that I have to accept it is not much more than that, and it would be irrational of me to assign it the utmost importance.\n That being said, it might actually be “not that deep” (for the sake of incorporating some teenage slang), feeling nice once in a while isn’t a crime and I will continue to enjoy with greatest gratitude the honor of being allowed to love someone. \n It is just reassuring to know I'm not entirely on the wrong track when relationships are falling apart due to my partner being incompatible with my working attitude. It might totally be for others and it might totally feel that way for me every once in a while, but deep down I know that this is what I truly prefer, because I can sit still just working on projects and not dating anyone but I cannot possibly sit still dating someone and not working on projects.\n And I believe that is my demise and that it is some kind of ironic fate I will never really overcome, conveniently though, because I don't want to overcome it. I adore the idea of retiring in a chalet in the austrian mountain range, counting cows I meet on the pebble path to the small organic store in the village and talking to neighboring families I meet on my way back. I can guarantee that I will get there, but half of my days will still be spent in front of a screen, with a better view and worse wifi, better air to breathe and less weight on my shoulders.\n Maybe there'll be someone who appreciates a life with me, even if I am like I am. Maybe not. Maybe someday I'll find someone so special to me that I'll shove work away and dedicate all of my evening to them. Maybe not. Every friday night, I'll still sit on my porch all the same, and I'll enjoy the cold mountain breeze against my neck.\n And for the realistic possibility that this might not appeal to anyone, it does to me. That is enough, right?",
    words: 381,
    categories: ["Love", "Relationships"],
    dateWritten: "2026-30-03T00:00:00Z",
    author: "",
  },
  {
    id: 2,
